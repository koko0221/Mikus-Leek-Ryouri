...
## Overview:
" Miku's Leek Ryouri " is a cooking mod inspired by the themes of "Hatsune Miku" and "leeks".<br>
...
**Q: How can this mod be used?**<br>
A: The source code is licensed under the LGPL-3.0 open-source license.<br>
Except for designated artworks, which remain the property of the original authors, art and model resources are licensed under CC BY-NC-SA 4.0.<br>
